    ...
    const handleSearch = (e) => {
        if (e.target.value.length === 0) {
            ...
            const newData = tableData.filter(
                (val) => val.cname.toLocaleLowerCase().includes(e.target.value.toLocaleLowerCase())
            );
        ...
        <div>
            ...
            <div className='px-2 py-2 w-full m-auto'>
                <div className='py-5 drop-shadow-md'>
                    ...
                    <h1 className='text-center text-[30px]'>List of Invoice</h1>
                    ...
                    <div>
                        <div>
                            ...
                            <div id='journal-scroll' className="overflow-x-scroll w-full mt-5 ">
                                <InvoiceListTable
